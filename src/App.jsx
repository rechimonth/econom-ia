...
export default function App() {
        ...
        <footer className="border-t border-slate-900 bg-slate-950/80 py-4 px-4 text-center text-xs text-slate-500">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => setIsProfileOpen(true)} className="text-sky-400 hover:text-sky-300 underline">
                Configurar perfil
              </button>
            </div>
          </div>
  ...
  function renderTabContent() {
    switch (activeTab) {
      ...
      case 'copiloto':
        return <CopilotWidget userProfile={userProfile} setActiveTab={setActiveTab} onAskCopilot={handleAskCopilot} recentTickets={recentTickets} />;
      case 'gemelo':
        return <EconomicTwin userProfile={userProfile} onAskCopilot={handleAskCopilot} setActiveTab={setActiveTab} />;
      case 'chat':
        return (
          <ChatCopilot
            userProfile={userProfile}
      ...
      case 'inflacion':
        return <InflationCalculator userProfile={userProfile} onAskCopilot={handleAskCopilot} setActiveTab={setActiveTab} />;
      case 'precios':
        return <PriceComparator onAskCopilot={handleAskCopilot} setActiveTab={setActiveTab} />;
      case 'tickets':
        return <TicketScanner onAddTicket={handleAddScannedTicket} onAskCopilot={handleAskCopilot} setActiveTab={setActiveTab} />;
      case 'comunidad':
        return <CommunityWaze userProfile={userProfile} onAskCopilot={handleAskCopilot} setActiveTab={setActiveTab} />;
      case 'mapa':
        return <EconomicMap userProfile={userProfile} onAskCopilot={handleAskCopilot} setActiveTab={setActiveTab} />;
      case 'dossier':
